...
var NodoConectorHttpServer = function(opt){
    ...
    this.app.post('/session/' + this.idSesion, function(request, response){       
        ...
        request.on('end', function () {
            if(_this.mensajeParcial!=""){     
				if(_this.verbose) console.log("Recibido en request: " + _this.mensajeParcial);
				var mensajes_desde_el_cliente = [];
				try{
                	mensajes_desde_el_cliente = JSON.parse(qs.parse(_this.mensajeParcial).mensajes_vortex).contenidos;
				}catch(e){
					mensajes_desde_el_cliente = JSON.parse(JSON.parse(_this.mensajeParcial).mensajes_vortex).contenidos;
				}				
...
NodoConectorHttpServer.prototype.resetTiempoDevida = function(){
    var _this = this;
...
NodoConectorHttpServer.prototype.conectarCon = function(un_nodo){
    this.receptor = un_nodo;
};

NodoConectorHttpServer.prototype.desconectarDe = function(un_nodo){
    this.receptor = {
...
NodoConectorHttpServer.prototype.recibirMensaje = function(mensaje){
...
NodoConectorHttpServer.prototype.recibirMensajePorHttp = function(mensaje){
...
NodoConectorHttpServer.prototype.getMensajesRecibidos = function(){
...
exports.clase = NodoConectorHttpServer;